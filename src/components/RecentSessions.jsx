...
const s = {
  wrapper: { borderRadius: 14, padding: '22px', height: '100%', display: 'flex', flexDirection: 'column' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  title: { fontSize: 16, fontWeight: 600 },
  viewAllBtn: { background: 'transparent', border: 'none', cursor: 'pointer', fontSize: 13, fontWeight: 600 },
  list: { display: 'flex', flexDirection: 'column', gap: 10, overflowY: 'auto', flex: 1 },
  entry: { display: 'flex', alignItems: 'stretch', borderRadius: 10, overflow: 'hidden' },
  colorBar: { width: 4, flexShrink: 0 },
  entryContent: { flex: 1, padding: '13px 16px', display: 'flex', flexDirection: 'column', gap: 5 },
  entryTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  entryLeft: { display: 'flex', alignItems: 'center', gap: 7 },
  entryBottom: { display: 'flex', alignItems: 'center', gap: 9, flexWrap: 'wrap' },
  category: { fontSize: 13, fontWeight: 600 },
  dot: { fontSize: 11 },
  subcategory: { fontSize: 13 },
  duration: { fontSize: 14, fontWeight: 600 },
  time: { fontSize: 12 },
  desc: { fontSize: 12, fontStyle: 'italic' },
  empty: { borderRadius: 14, padding: '36px', textAlign: 'center' },
